...
//`user_id`, `name`, `profile_img`, `gender`, `address`, `mobile_no`, `user_name`, `password`, 
//`reset_link_token`, `exp_date`, `verifyed`, `created_on` SELECT * FROM `users` WHERE 1
if(isset($_POST['update']))
{
	...
	$update=mysqli_query($conn,"update  users  set name='$name', gender='$gender', address='$address' where user_id='$user_id'");
...
<html lang="en">
    ...
    <body>
		...
		<?php
		//`user_id`, `name`, `profile_img`, `gender`, `address`, `mobile_no`, `user_name`, `password`, `reset_link_token`, 
		//`exp_date`, `verifyed`, `created_on` SELECT * FROM `users` WHERE 1
							...
							<div class="row">
								<div class="col-lg-3 bg-white pt-3" >
									<div class="text-center">
										<img src="img/images/user.png" width="80px" alt="">
									</div>
									<div class="text-center">
										<p>Hello,</p>
								...
								<div class="col-lg-5">								
									<h4 class="pt-3">Personal Information</h4>
											...
											<h4 class="pt-3">Manage Addresses</h4>		
											<div class="row pb-3" >								
												<div class="col-lg-12">
													<textarea name="address" id="address" class="form-control"  cols="10"><?php echo $user_details['address'];?></textarea>
												</div>
								...
								<div class="col-lg-4">
											<h4 class="pt-3">Email Address</h4>
											<div class="row pb-3">										
												<div class="col-lg-12 d-flex">
													<input type="text"  class="form-control" readonly value="<?php echo $user_details['user_name'];?>" placeholder="">
												</div>
											</div>
											<h4>Mobile No.</h4>
											<div class="row pb-3">										
												<div class="col-lg-12 d-flex">
													<input type="text"  class="form-control"readonly value="<?php echo $user_details['mobile_no'];?>">
												</div>
											</div>										
								</div>
