...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <main>
            ...
            <!-- discount-area -->
            <section class="discount-area pt-50 pb-40">
                <div class="container">
                    ...
                    <div class="special-products-wrap">
                        <div class="row">
                            ...
                            <div class="col-9">
                                ...
                                $live_sql="SELECT * FROM product_details  WHERE prod_live=1 order by prod_id DESC";
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6 col-4">
                                        <div class="sp-product-item mb-20">
                                            ...
                                            <div class="sp-product-content">
                                                ...
                                                -->
                                                <h6 class="title"><a href=""><?php echo $live_product['prod_name'];?></a></h6>
                                                <!--<span class="product-status">Out of Stock</span>-->

                                                <p class="pt-2"><span>₹</span><?php echo $live_product['prod_price'];?></p>

                                                <small>M.R.P.: ₹ <?php echo $live_product['prod_mrp'];?></small>
            ...
            <section class="best-sellers-area pt-75">
                <div class="container">
                    ...
                    <div class="best-sellers-products">
                        ...
                        $best_sql="SELECT * FROM product_details  WHERE prod_best=1 order by prod_id DESC";
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-4">
                                    <div class="sp-product-item mb-20">
                                        ...
                                        <div class="sp-product-content">
                                            ...
                                            -->
                                            <h6 class="title"><a href=""><?php echo $best_product['prod_name'];?></a></h6>
                                            <!--<span class="product-status">Out of Stock</span>-->

                                            <p class="pt-2"><span>₹</span><?php echo $best_product['prod_price'];?></p>

                                            <small>M.R.P.: ₹ <?php echo $best_product['prod_mrp'];?></small>
...
<!-- Mirrored from themebeyond.com/pre/ganic-prev/ganic-live/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 May 2023 18:13:30 GMT -->
</html>
