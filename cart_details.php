                            ...
                            <div class="breadcrumb-content">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="cart_details.html">Shopping Cart</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="card rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            <div class="row d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="col-6 col-sm-6 col-md-8 col-lg-2 col-xl-2">
                                ...
                                <div class="shop-cart-widget">
                                    <form action="" method="post">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="shop-check-wrap">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label" for="customCheck2">LOCAL PICKUP:
                                                            $5.00</label>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <span class="amount">
                                                ₹ <?php echo number_format($sub_total*1+150,2);?>
                                            </span>
                                            </li>
                                        </ul>
